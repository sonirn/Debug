...
class DatabaseService {
  ...
  async testConnection() {
    ...
    try {
      ...
      const testClient = new MongoClient(mongoUrl, simpleOptions);
      
      await testClient.connect();
      console.log('✅ MongoDB connection successful!');
      
      const db = testClient.db(process.env.DB_NAME || 'apk_converter');
      await db.admin().ping();
      ...
      console.log('✅ MongoDB read test successful!', doc ? 'Found document' : 'No document');
